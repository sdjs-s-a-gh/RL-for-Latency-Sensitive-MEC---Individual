...
/**
 * A task generated by a user device.
 *
 * This structure (like a class) represents a task generated by a user device within the simulation.
 * The structure contains a significant number of attributes that are required for both the task
 * to be processed and for relevant metrics to be captured.
 *
 */
